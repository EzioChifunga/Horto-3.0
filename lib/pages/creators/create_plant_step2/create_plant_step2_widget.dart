...
import 'create_plant_step2_model.dart';
export 'create_plant_step2_model.dart';

class CreatePlantStep2Widget extends StatefulWidget {
  const CreatePlantStep2Widget({super.key});

  @override
  State<CreatePlantStep2Widget> createState() => _CreatePlantStep2WidgetState();
}

class _CreatePlantStep2WidgetState extends State<CreatePlantStep2Widget> {
  late CreatePlantStep2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreatePlantStep2Model());
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              context.pushNamed('CreatePlantStep3');
                            },
                            text: 'Seguinte',
                            options: FFButtonOptions(
                              width: 212.0,
