...
import 'schema/plants_profile_record.dart';
...
export 'schema/plants_profile_record.dart';
...
/// Functions to query PlantsProfileRecords (as a Stream and as a Future).
Future<int> queryPlantsProfileRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      PlantsProfileRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<PlantsProfileRecord>> queryPlantsProfileRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      PlantsProfileRecord.collection,
      PlantsProfileRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<PlantsProfileRecord>> queryPlantsProfileRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
